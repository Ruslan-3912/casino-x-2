...
define('DB_USER', 'mysqldbuser@casino-riobet-official-mysqldbserver');

/** MySQL database password */
define('DB_PASSWORD', 'Rio3912-');

/** MySQL hostname */
define('DB_HOST', 'casino-riobet-official-mysqldbserver.mysql.database.azure.com');
