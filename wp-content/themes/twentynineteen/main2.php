...
<div style="display:flex;flex-direction:row">
  ...
  <div class="main1"> </div>
      <p>Сайт клуба Casino X можно запустить с разных устройств. Это может быть стационарный ПК, ноутбук, смартфон или планшет. Мобильная версия Казино Х разработана как адаптивная платформа, которая автоматически подстраивается под параметры девайса.	</p>
...
.for-f a:nth-child(2) .for-f1 {
    background: url(/img/8.png) no-repeat!important;
    background-size: 100% 100%!important;
    background-position: center top!important;
}
...
.for-f a:nth-child(4) .for-f1 {
    background: url(/img/10.png) no-repeat!important;
    background-size: 100% 100%!important;
    background-position: center top!important;
}
